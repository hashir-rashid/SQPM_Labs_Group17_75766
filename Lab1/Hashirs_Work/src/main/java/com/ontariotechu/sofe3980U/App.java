...
public class App 
{
	...
	*      Then it will create two binary variables, add them, bitwise or/and them,
		   multiply them, and print the results.
	*
	* @param args: not used
	*/
    public static void main( String[] args )
    {
		...
		System.out.println( "The result of their bitwise OR is "+or.getValue());
		Binary and= Binary.and(binary1,binary2);
		System.out.println( "The result of their bitwise AND is "+and.getValue());
